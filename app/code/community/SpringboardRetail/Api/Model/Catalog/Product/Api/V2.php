...
class Springboard_Retail_Api_Model_Catalog_Product_Api_V2 extends Mage_Catalog_Model_Product_Api_V2
{
    ...
    protected function _prepareDataForSave($product, $productData)
    {
        ...
        if (property_exists($productData, 'categories')) {
            $categoryIds = Mage::helper('springboard_retail_api/catalog_product')
            ...
            if ($singleDataExists || $multiDataExists) {
                if ($singleDataExists) {
                    foreach ($productData->additional_attributes->single_data as $_attribute) {
                        ...
                        $productData->$_attrCode = Mage::helper('springboard_retail_api/catalog_product')
